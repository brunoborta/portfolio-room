...
export function Clock(props) {
  ...
  return (
    <group {...props} dispose={null}>
      ...
      <mesh name="HourHand" castShadow geometry={nodes.HourHand.geometry} material={materials.White} position={[-5.511, 7.172, 0.341]} rotation={[3.044, -0.756, time.hourRotation]} scale={[0.032, 0.158, 0.032]} />
    </group>
  )
}
